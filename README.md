...
###### **8.Evaluate model using: (R² Score), (Adjusted R² Score), (Mean Squared Error (MSE))**

###### **9.Visualize results using: (Actual vs Predicted Plot), (Residual Plot)**
